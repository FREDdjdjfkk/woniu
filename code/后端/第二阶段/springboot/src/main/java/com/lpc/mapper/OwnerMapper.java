...
public interface OwnerMapper {
    ...
    @Update("update owner set username=#{username},tel=#{tel},sex=#{sex},identity=#{identity},house_id=#{house_id},remarks=#{remarks},password=#{password},isDelete=#{isDelete},deltime=#{deltime} where id=#{id}")
